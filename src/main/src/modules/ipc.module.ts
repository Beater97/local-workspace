...
// 📦 KanbanColumn
handleIpc<[Partial<KanbanColumn>], number>('kanbanColumn:create', (data) =>
  KanbanColumnCRUD.create(data)
)
handleIpc<[], KanbanColumn[]>('kanbanColumn:readAll', () => KanbanColumnCRUD.readAll())
handleIpc<[number], KanbanColumn | undefined>('kanbanColumn:readById', (id) =>
  KanbanColumnCRUD.readById(id)
)
handleIpc<[number, Partial<KanbanColumn>], void>('kanbanColumn:update', (id, data) =>
  KanbanColumnCRUD.update(id, data)
)
...
handleIpc<[number, Partial<Folder>], void>('folder:update', (id, data) =>
  FolderCRUD.update(id, data)
)
...
handleIpc<[number], Attachment | undefined>('attachment:readById', (id) =>
  AttachmentCRUD.readById(id)
)
handleIpc<[number, Partial<Attachment>], void>('attachment:update', (id, data) =>
  AttachmentCRUD.update(id, data)
)
...
handleIpc<[number, Partial<Password>], void>('password:update', (id, data) =>
  PasswordCRUD.update(id, data)
)
